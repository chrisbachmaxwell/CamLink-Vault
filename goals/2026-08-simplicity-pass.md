...
- 2026-08-28 · Direct-cloud live-grid regression corrected in code PR 8
  ...
  multi-room smokes, browser UI gate and GitHub Node 20/22 CI passed. The PR
  merged at `de0a2d9` and the independently hashed arm64 v0.19.6 update and DMG
  are live; real-camera field proof is still open.
